...
namespace SMEAppHouse.Core.GHClientLib.Api
{
    ...
    public partial class MatrixApi : IMatrixApi
    {
        ...
        /// <returns></returns>
        public MatrixApi(RestSharpClientLib.Configuration configuration = null)
        {
        ...
        public ApiResponse< MatrixResponse > MatrixGetWithHttpInfo (string key, List<string> point = null, List<string> fromPoint = null, List<string> toPoint = null, List<string> outArray = null, string vehicle = null)
        {
            ...
            if (fromPoint != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "from_point", fromPoint)); // query parameter
            if (toPoint != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "to_point", toPoint)); // query parameter
            if (outArray != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("multi", "out_array", outArray)); // query parameter
